...
def jarvis_patrick_clustering():
    ...
    plt.xlabel('K')
    plt.ylabel('S_min')
    plt.title('S_min vs k (ARI colored)')
    ...
    plt.xlabel('K')
    plt.ylabel('S_min')
    plt.title('S_min vs k (SSE colored)')
    plt.suptitle('Jarvis - Patrick Clustering')
    plt.colorbar()
    plt.grid(True)
    pdf_pages.savefig()  
    ...
    plt.figure(figsize=(8, 6))
    plot_ARI=plt.scatter(data[1000*highest_ari_index:(highest_ari_index+1)*1000, 0], data[1000*highest_ari_index:(highest_ari_index+1)*1000, 1], c=preds_final[highest_ari_index], cmap='jet', marker='^')
    plt.title(f'(Highest ARI) - Clustering for Dataset {i+1} ')
    plt.suptitle('Jarvis - Patrick Clustering')
    ...
    plt.figure(figsize=(8, 6))
    plot_SSE=plt.scatter(data[1000*least_sse_index:(least_sse_index+1)*1000, 0], data[1000*least_sse_index:(least_sse_index+1)*1000, 1], c=preds_final[least_sse_index], cmap='jet', marker='^')
    plt.title(f'(Lowest SSE) - Clustering for Dataset {i+1} ')
    plt.suptitle('Jarvis - Patrick Clustering')
    plt.xlabel(f'Feature 1')
    plt.ylabel(f'Feature 2')
    plt.colorbar()
